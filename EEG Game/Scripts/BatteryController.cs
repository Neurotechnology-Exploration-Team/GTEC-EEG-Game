...
public class BatteryController : MonoBehaviour
{
    ...
    private void OnBatteryLevelAvailable(object sender, EventArgs e)
    {
        BatteryLevelEventArgs batLvl = (BatteryLevelEventArgs)e;
        _currenBatteryLevel = batLvl.BatteryLevel;
        _update = true;
    }
